    ...
    return (
      <div className="App">
        <header className="App-header">
          ...
          <h2 className="App-title">Click on the id for details of a book</h2>
        </header>
        ...
        :
        <div>
          <h3><i className="fa fa-arrow-left" onClick={()=>this.setState({item:null})} style={{cursor:'pointer'}} ></i> Book Detail</h3>
